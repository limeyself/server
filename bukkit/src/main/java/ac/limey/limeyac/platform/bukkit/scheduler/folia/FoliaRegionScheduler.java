...
import ac.limey.limeyac.platform.api.scheduler.RegionScheduler;
...
import ac.limey.limeyac.platform.bukkit.world.BukkitPlatformWorld;
...
public class FoliaRegionScheduler implements RegionScheduler {
    ...
    public void execute(@NotNull GrimPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task) {
        regionScheduler.execute(LimeyBukkitLoaderPlugin.LOADER, ((BukkitPlatformWorld) world).bukkitWorld(), chunkX, chunkZ, task);
    }
