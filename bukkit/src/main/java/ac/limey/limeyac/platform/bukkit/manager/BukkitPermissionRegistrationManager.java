...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "limey.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "limey.exempt", "limey.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "limey.exempt.checkname").
