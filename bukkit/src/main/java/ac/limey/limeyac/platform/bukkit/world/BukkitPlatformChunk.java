package ac.limey.limeyac.platform.bukkit.world;
...
public class BukkitPlatformChunk implements PlatformChunk {
    ...
    private static final Map<BlockData, Integer> blockDataToId = LimeyAPI.INSTANCE.getPlatform() == Platform.FOLIA ? new ConcurrentHashMap<>() : new HashMap<>();
