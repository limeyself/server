...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "limey.exempt.checkname")
     * are available for autocomplete before Limey attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "limey.exempt").
