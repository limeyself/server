...
@CheckData(name = "PositionBreakB", stableKey = "limey.breaking.position_break_b", description = "Cancelled block breaking with an invalid block face")
public class PositionBreakB extends Check implements BlockBreakListener {
    ...
    public PositionBreakB(LimeyPlayer player) {
        super(player);
    }
