...
@CheckData(name = "AirLiquidPlace", stableKey = "limey.scaffolding.air_liquid_place", description = "Placed a block against an invalid support")
public class AirLiquidPlace extends BlockPlaceCheck implements BlockPlaceListener {
    public AirLiquidPlace(LimeyPlayer player) {
        super(player);
    }
    ...
    public void onBlockPlace(final BlockPlace place) {
        ...
        int currentTick = LimeyAPI.INSTANCE.getTickManager().currentTick;
