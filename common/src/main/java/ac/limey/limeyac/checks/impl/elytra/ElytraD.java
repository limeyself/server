...
@CheckData(name = "ElytraD", stableKey = "limey.elytra.no_elytra", description = "Started gliding without an elytra", experimental = true)
public class ElytraD extends Check implements PacketReceiveListener, PostPredictionListener {
    private boolean setback;

    public ElytraD(LimeyPlayer player) {
        super(player);
    }
