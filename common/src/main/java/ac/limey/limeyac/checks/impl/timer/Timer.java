...
@CheckData(name = "Timer", stableKey = "limey.timer.timer", configName = "TimerA", description = "The players game is running faster than normal", setback = 10)
public class Timer extends Check implements PrePredictionPacketReceiveListener {
    ...
    public Timer(LimeyPlayer player) {
        super(player);
    }
