...
import ac.limey.limeyac.checks.impl.multiactions.MultiActionsC;
...
@CheckData(name = "ChatC", stableKey = "limey.chat.moving_while_chatting", description = "Moving while chatting", experimental = true)
public class ChatC extends Check implements PreViaPacketReceiveListener {
    ...
    public ChatC(LimeyPlayer player) {
        super(player);
    }
