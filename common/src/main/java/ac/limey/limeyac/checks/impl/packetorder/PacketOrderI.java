...
@CheckData(name = "PacketOrderI", stableKey = "limey.packetorder.input_tick_order", description = "Sent combat, use, release, or digging packets in an invalid tick order", experimental = true)
public class PacketOrderI extends Check implements PacketReceiveListener, PostPredictionListener {
    ...
    public PacketOrderI(final LimeyPlayer player) {
        super(player);
    }
