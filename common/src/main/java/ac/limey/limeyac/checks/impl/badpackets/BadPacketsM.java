...
import ac.limey.limeyac.checks.type.PreViaPacketSendListener;
...
@CheckData(name = "BadPacketsM", stableKey = "limey.badpackets.respawn_alive", description = "Tried to respawn while alive", experimental = true)
public class BadPacketsM extends Check implements PreViaPacketReceiveListener, PreViaPacketSendListener {
    public BadPacketsM(final LimeyPlayer player) {
        super(player);
    }
