...
@CheckData(name = "PacketOrderH", stableKey = "limey.packetorder.sneak_sprint_order", description = "Sent sprinting and sneaking state changes in an invalid packet order", experimental = true)
public class PacketOrderH extends Check implements PacketReceiveListener, PostPredictionListener {
    public PacketOrderH(final LimeyPlayer player) {
        super(player);
    }
