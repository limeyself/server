...
import ac.limey.limeyac.checks.type.PostFlyingBlockBreakListener;
...
@CheckData(name = "RotationBreak", stableKey = "limey.breaking.rotation_break", description = "Tried to break a block without looking at it", experimental = true)
public class RotationBreak extends Check implements BlockBreakListener, PostFlyingBlockBreakListener {
    ...
    public RotationBreak(LimeyPlayer player) {
        super(player);
    }
