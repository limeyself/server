...
@CheckData(name = "AntiExplosion", stableKey = "limey.velocity.anti_explosion", configName = "Explosion", description = "Did not take the expected explosion knockback", setback = 10)
public class ExplosionHandler extends Check implements PacketSendListener, PostPredictionListener {
    ...
    public ExplosionHandler(LimeyPlayer player) {
        super(player);
    }
