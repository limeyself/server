...
@CheckData(name = "VehicleF", stableKey = "limey.vehicle.boat_input_mismatch", experimental = true, description = "Sent incorrect boat paddle states")
public class VehicleF extends Check implements PacketReceiveListener {
    private static final Verbose V =
            Verbose.of("sent=({bool}, {bool}), expected=({bool}, {bool})");

    public VehicleF(LimeyPlayer player) {
        super(player);
    }
