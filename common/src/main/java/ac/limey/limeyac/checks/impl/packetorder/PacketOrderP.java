...
@CheckData(name = "PacketOrderP", stableKey = "limey.packetorder.transaction_response_order", description = "Responded to chunk batch packets in an invalid transaction order", experimental = true)
public class PacketOrderP extends Check implements PacketReceiveListener, PacketSendListener {
    ...
    public PacketOrderP(final LimeyPlayer player) {
        super(player);
    }
