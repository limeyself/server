...
@CheckData(name = "AirLiquidBreak", stableKey = "limey.breaking.air_liquid_break", description = "Breaking a block that cannot be broken")
public class AirLiquidBreak extends Check implements BlockBreakListener {
    ...
    public AirLiquidBreak(LimeyPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        int newTick = LimeyAPI.INSTANCE.getTickManager().currentTick;
        if (lastTick == newTick
