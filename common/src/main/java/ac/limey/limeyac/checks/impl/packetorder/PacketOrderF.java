...
@CheckData(name = "PacketOrderF", stableKey = "limey.packetorder.input_tick_to_sneak_sprint_order", description = "Sent action packets after sneak or sprint input in an invalid order", experimental = true)
public class PacketOrderF extends Check implements PacketReceiveListener, PostPredictionListener {
    ...
    public PacketOrderF(LimeyPlayer player) {
        super(player);
    }
