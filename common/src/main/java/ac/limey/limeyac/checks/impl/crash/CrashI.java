...
@CheckData(name = "CrashI", stableKey = "limey.crash.invalid_bundle_slot", description = "Sent a bundle item selection with an invalid negative slot index")
public class CrashI extends Check implements PacketReceiveListener {
    ...
    public CrashI(LimeyPlayer player) {
        super(player);
    }
