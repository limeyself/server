...
@CheckData(name = "PacketOrderC", stableKey = "limey.packetorder.interact_order", description = "Sent INTERACT and INTERACT_AT entity packets in the wrong order")
public class PacketOrderC extends Check implements PreViaPacketReceiveListener {
    ...
    public PacketOrderC(final LimeyPlayer player) {
        super(player);
    }
