...
@CheckData(name = "BadPacketsR", stableKey = "limey.badpackets.position_starvation", description = "Stopped sending position updates while still responding to transactions", decay = 0.25, experimental = true)
public class BadPacketsR extends Check implements PacketReceiveListener {
    ...
    public BadPacketsR(final LimeyPlayer player) {
        super(player);
    }
