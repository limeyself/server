...
@CheckData(name = "SprintE", stableKey = "limey.sprint.wall", description = "Sprinting while colliding with a wall", setback = 5, experimental = true)
public class SprintE extends Check implements PacketReceiveListener, PostPredictionListener {
    ...
    public SprintE(LimeyPlayer player) {
        super(player);
    }
