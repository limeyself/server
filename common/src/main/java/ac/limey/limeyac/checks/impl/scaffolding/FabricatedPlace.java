...
@CheckData(name = "FabricatedPlace", stableKey = "limey.scaffolding.fabricated_place", description = "Sent out of bounds cursor position")
public class FabricatedPlace extends BlockPlaceCheck implements BlockPlaceListener {
    ...
    public FabricatedPlace(LimeyPlayer player) {
        super(player);
    }
