...
@CheckData(name = "MultiInteractB", stableKey = "limey.multiinteract.interact_at_position_changed", description = "Sent multiple entity interaction packets with different hit positions in one tick", experimental = true)
public class MultiInteractB extends Check implements PacketReceiveListener, PostPredictionListener {
    ...
    public MultiInteractB(final LimeyPlayer player) {
        super(player);
    }
