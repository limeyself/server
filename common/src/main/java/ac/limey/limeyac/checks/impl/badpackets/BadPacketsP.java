...
@CheckData(name = "BadPacketsP", stableKey = "limey.badpackets.invalid_click", description = "Invalid window click packet", experimental = true)
public class BadPacketsP extends Check implements PacketReceiveListener, PacketSendListener {
    ...
    public BadPacketsP(LimeyPlayer playerData) {
        super(playerData);
    }
