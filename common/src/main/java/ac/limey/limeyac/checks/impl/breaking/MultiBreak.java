...
@CheckData(name = "MultiBreak", stableKey = "limey.breaking.multi_break", description = "Tried to break multiple different blocks in the same movement tick", experimental = true)
public class MultiBreak extends Check implements BlockBreakListener, PreViaPacketReceiveListener, PostPredictionListener {
    ...
    public MultiBreak(LimeyPlayer player) {
        super(player);
    }
