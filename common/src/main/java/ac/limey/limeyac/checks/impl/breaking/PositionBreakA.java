...
@CheckData(name = "PositionBreakA", stableKey = "limey.breaking.position_break_a", description = "Tried to break a block face from an impossible eye position")
public class PositionBreakA extends Check implements BlockBreakListener {
    ...
    public PositionBreakA(LimeyPlayer player) {
        super(player);
    }
