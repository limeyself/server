...
@CheckData(name = "BadPacketsU", stableKey = "limey.badpackets.invalid_block_placement", description = "Sent impossible use item packet")
public class BadPacketsU extends Check implements PacketReceiveListener {
    ...
    public BadPacketsU(LimeyPlayer player) {
        super(player);
    }
