...
@CheckData(name = "MultiActionsG", stableKey = "limey.multiactions.action_while_rowing", description = "Attacking or using items while rowing a boat", experimental = true)
public class MultiActionsG extends BlockPlaceCheck implements PacketReceiveListener, BlockPlaceListener {
    ...
    public MultiActionsG(LimeyPlayer player) {
        super(player);
    }
