...
import ac.limey.limeyac.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionListener {
    ...
    private final Set<LimeyPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(LimeyPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (LimeyPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = LimeyAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(LimeyPlayer player) {
