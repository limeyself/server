...
@CheckData(name = "PacketOrderD", stableKey = "limey.packetorder.interact_hand_order", description = "Sent offhand entity interaction before the matching mainhand interaction", experimental = true)
public class PacketOrderD extends Check implements PreViaPacketReceiveListener {
    ...
    public PacketOrderD(final LimeyPlayer player) {
        super(player);
    }
