...
@CheckData(name = "PacketOrderO", stableKey = "limey.packetorder.tick_end_order", description = "Sent packets after movement before the expected client tick end", experimental = true)
public class PacketOrderO extends Check implements PacketReceiveListener {
    ...
    public PacketOrderO(final LimeyPlayer player) {
        super(player);
    }
