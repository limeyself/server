...
@CheckData(name = "PacketOrderM", stableKey = "limey.packetorder.interact_use_order", description = "Sent use item and entity interaction packets in an invalid order", experimental = true)
public class PacketOrderM extends Check implements PacketReceiveListener, PostPredictionListener {
    public PacketOrderM(final LimeyPlayer player) {
        super(player);
    }
