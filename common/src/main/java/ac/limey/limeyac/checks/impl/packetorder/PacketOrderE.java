...
@CheckData(name = "PacketOrderE", stableKey = "limey.packetorder.slot_order", description = "Changed held item slot during another conflicting action", experimental = true)
public class PacketOrderE extends Check implements PacketReceiveListener, PostPredictionListener {
    ...
    public PacketOrderE(final LimeyPlayer player) {
        super(player);
    }
