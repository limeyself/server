...
@CheckData(name = "TimerLimit", stableKey = "limey.timer.limit", description = "The player has sent too many packets after high latency", setback = 10)
public class TimerLimit extends Timer {
    ...
    public TimerLimit(LimeyPlayer player) {
        super(player);
    }
