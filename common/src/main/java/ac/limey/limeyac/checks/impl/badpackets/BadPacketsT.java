...
@CheckData(name = "BadPacketsT", stableKey = "limey.badpackets.invalid_interact_vector", description = "Sent an entity interaction vector outside the target player's hitbox")
public class BadPacketsT extends Check implements PacketReceiveListener {
    ...
    public BadPacketsT(final LimeyPlayer player) {
        super(player);
        // 1.7 and 1.8 seem to have different hitbox "expansion" values than 1.9+
        // https://github.com/LimeyAnticheat/Limey/pull/1274#issuecomment-1872458702
        // https://github.com/LimeyAnticheat/Limey/pull/1274#issuecomment-1872533497
