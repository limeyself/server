...
@CheckData(name = "BadPacketsX", stableKey = "limey.badpackets.extra_input_actions", description = "Sent duplicate sneak or sprint input actions before the next movement packet", experimental = true)
public class BadPacketsX extends Check implements PacketReceiveListener, PostPredictionListener {
    private boolean sprint;
    private boolean sneak;
    private int flags;

    public BadPacketsX(LimeyPlayer player) {
        super(player);
    }
