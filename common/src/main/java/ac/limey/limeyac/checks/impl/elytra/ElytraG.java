...
@CheckData(name = "ElytraG", stableKey = "limey.elytra.levitation", description = "Started gliding with levitation", experimental = true)
public class ElytraG extends Check implements PacketReceiveListener, PostPredictionListener {
    private boolean setback;

    public ElytraG(LimeyPlayer player) {
        super(player);
    }
