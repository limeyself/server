package ac.limey.limeyac.checks.impl.groundspoof;
...
@CheckData(name = "NoFall", stableKey = "limey.groundspoof.no_fall", description = "Sent an on-ground packet while not colliding with the ground", setback = 10)
public class NoFall extends Check implements PacketReceiveListener {

    public boolean flipPlayerGroundStatus = false;

    public NoFall(LimeyPlayer player) {
        super(player);
    }
