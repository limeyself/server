...
@CheckData(name = "FarBreak", stableKey = "limey.breaking.far_break", description = "Breaking blocks too far away", experimental = true)
public class FarBreak extends Check implements BlockBreakListener {
    ...
    public FarBreak(LimeyPlayer player) {
        super(player);
    }
