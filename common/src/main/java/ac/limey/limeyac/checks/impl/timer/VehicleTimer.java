...
@CheckData(name = "VehicleTimer", stableKey = "limey.timer.vehicle", description = "Sent vehicle movement packets faster than the expected client tick rate", setback = 10)
public class VehicleTimer extends Timer {
    private boolean isDummy = false;

    public VehicleTimer(LimeyPlayer player) {
        super(player);
    }
