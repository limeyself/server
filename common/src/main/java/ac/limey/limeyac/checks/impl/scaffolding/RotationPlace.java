...
@CheckData(name = "RotationPlace", stableKey = "limey.scaffolding.rotation_place", description = "Placed a block while not looking at it")
public class RotationPlace extends BlockPlaceCheck implements BlockPlaceListener, PostFlyingBlockPlaceListener {
    ...
    public RotationPlace(LimeyPlayer player) {
        super(player);
    }
