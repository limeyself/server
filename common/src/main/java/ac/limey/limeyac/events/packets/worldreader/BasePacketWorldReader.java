package ac.limey.limeyac.events.packets.worldreader;

import ac.limey.limeyac.LimeyAPI;
import ac.limey.limeyac.player.LimeyPlayer;
import ac.limey.limeyac.utils.chunks.Column;
import ac.limey.limeyac.utils.data.TeleportData;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(LimeyPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(LimeyPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, LimeyPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ, TileEntity[] tileEntities) {
    ...
    public void unloadChunk(LimeyPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(LimeyPlayer player, PacketSendEvent event) {
    ...
    public void handleMultiBlockChange(LimeyPlayer player, PacketSendEvent event) {
