...
import ac.limey.limeyac.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, LimeyPlayer player, int entityId) {
        if (isInvalidEntity(event, player, entityId)) return;
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, LimeyPlayer player, int entityId) {
