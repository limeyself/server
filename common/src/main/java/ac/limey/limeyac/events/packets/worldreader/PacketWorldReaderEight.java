...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final LimeyPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final LimeyPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
