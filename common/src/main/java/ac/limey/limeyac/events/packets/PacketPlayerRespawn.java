...
import ac.limey.limeyac.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.addRealTimeTaskNext(() -> {
                ...
                if (!LimeyAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(LimeyPlayer player, WrapperPlayServerRespawn respawn) {
