...
import ac.limey.limeyac.utils.math.Vec2;
...
public class ModernInputTransformer extends DoubleInputTransformer { // 1.21.5+
    ...
    public Vec2 modifyInput(LimeyPlayer player, Vec2 moveVector) {
    ...
    private float distanceToUnitSquare(Vec2 input) {
        ...
        return LimeyMath.sqrt(1.0F + LimeyMath.square(additional));
    }
    ...
    private float getItemUseSpeedMultiplier(LimeyPlayer player) {
