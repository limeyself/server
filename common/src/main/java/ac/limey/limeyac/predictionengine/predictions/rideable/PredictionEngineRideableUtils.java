...
import ac.limey.limeyac.utils.data.IntToObjectPair;
import ac.limey.limeyac.utils.data.VectorData;
import ac.limey.limeyac.utils.data.packetentity.JumpableEntity;
...
public final class PredictionEngineRideableUtils {
    ...
    public static Set<VectorData> handleJumps(LimeyPlayer player, Set<VectorData> possibleVectors) {
    ...
    public static List<VectorData> applyInputsToVelocityPossibilities(Input movementVector, LimeyPlayer player, Set<VectorData> possibleVectors, float speed) {
    ...
    private static void addStuckSpeedResults(LimeyPlayer player, List<VectorData> returnVectors, VectorData result) {
    ...
    private static void addPossibleStuckSpeedResults(LimeyPlayer player, List<VectorData> returnVectors, VectorData result) {
    ...
    private static void addStuckSpeedResult(LimeyPlayer player, List<VectorData> returnVectors, VectorData result, IndexedVector3d stuckSpeedMultiplier) {
    ...
    public static void applyPendingJumps(LimeyPlayer player) {
