...
import ac.limey.limeyac.predictionengine.predictions.input.DoubleInput;
...
public class DoubleInputTransformer implements InputTransformer<DoubleInput> { // 1.14 - 1.21.4
    @Override
    public DoubleInput transformInputsToVector(LimeyPlayer player, int sideways, int vertical, int forward) {
        float bestPossibleX;
        float bestPossibleZ;
