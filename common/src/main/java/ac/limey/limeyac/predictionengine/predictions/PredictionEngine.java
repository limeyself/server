...
import ac.limey.limeyac.predictionengine.movementtick.MovementTickerPlayer;
import ac.limey.limeyac.predictionengine.predictions.input.Input;
import ac.limey.limeyac.predictionengine.predictions.input.InputTransformer;
import ac.limey.limeyac.utils.collisions.datatypes.SimpleCollisionBox;
import ac.limey.limeyac.utils.data.IndexedVector3d;
import ac.limey.limeyac.utils.data.KnownInput;
import ac.limey.limeyac.utils.data.Triple;
...
import ac.limey.limeyac.utils.nmsutil.JumpPower;
import ac.limey.limeyac.utils.nmsutil.Riptide;
...
public class PredictionEngine {
    ...
    public static Vector3dm clampMovementToHardBorder(LimeyPlayer player, Vector3dm outputVel) {
        // TODO: Reimplement
        return outputVel;
    }

    public void guessBestMovement(float speed, LimeyPlayer player) {
    ...
    private Vector3dm doPredictions(LimeyPlayer player, List<VectorData> possibleVelocities, float speed) {
    ...
    private Triple<Vector3dm, Vector3dm, Vector3dm> doSeekingWallCollisions(LimeyPlayer player, Vector3dm primaryPushMovement, Vector3dm originalClientVel, VectorData clientVelAfterInput) {
    ...
    private void addZeroPointThreeToPossibilities(float speed, LimeyPlayer player, List<VectorData> possibleVelocities) {
    ...
    public void addFluidPushingToStartingVectors(LimeyPlayer player, Set<VectorData> data) {
    ...
    public Set<VectorData> fetchPossibleStartTickVectors(LimeyPlayer player) {
        ...
        // Inputs are done AFTER fluid pushing, https://github.com/MWHunter/Limey/issues/660
    ...
    private void addNonEffectiveAI(LimeyPlayer player, Set<VectorData> data) {
    ...
    private void addAttackSlowToPossibilities(LimeyPlayer player, Set<VectorData> velocities) {
    ...
    public void applyMovementThreshold(LimeyPlayer player, Set<VectorData> velocities) {
    ...
    public void addExplosionToPossibilities(LimeyPlayer player, Set<VectorData> existingVelocities) {
    ...
    public int sortVectorData(VectorData a, VectorData b, LimeyPlayer player) {
        int aScore = 0;
        int bScore = 0;
    ...
    public Vector3dm handleStartingVelocityUncertainty(LimeyPlayer player, VectorData vector, Vector3dm targetVec) {
        ...
        // https://github.com/MWHunter/Limey/issues/398
        ...
        //
        //
        // Limey's old solution with hard lerping entities was to just give a ton of direct offset reduction
    ...
    public void loopVectors(LimeyPlayer player, Set<VectorData> possibleVectors, float speed, List<VectorData> returnVectors, boolean doStuckSpeed) {
        // Stop omni-sprint
    ...
    private void addPossibleStuckSpeedResults(LimeyPlayer player, List<VectorData> returnVectors, VectorData result, boolean flipUsingItem) {
    ...
    private void addStuckSpeedResult(LimeyPlayer player, List<VectorData> returnVectors, VectorData result, IndexedVector3d stuckSpeedMultiplier, boolean flipUsingItem) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, LimeyPlayer player) {
        return vector;
    }

    public void doJump(LimeyPlayer player, Vector3dm vector) {
