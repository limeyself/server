...
public class EntityFluidInteraction {
    ...
    public void update(final LimeyPlayer player, final boolean ignoreCurrent) {
        ...
        int minX = LimeyMath.floor(aabb.minX);
        int minY = LimeyMath.floor(aabb.minY);
        int minZ = LimeyMath.floor(aabb.minZ);
        int maxX = LimeyMath.ceil(aabb.maxX) - 1;
        int maxY = LimeyMath.ceil(aabb.maxY) - 1;
        int maxZ = LimeyMath.ceil(aabb.maxZ) - 1;
        ...
        int playerX = LimeyMath.floor(player.lastX);
        double playerEyeY = player.lastY + player.getEyeHeight() - 0.1111111119389534D;
        int playerZ = LimeyMath.floor(player.lastZ);
    ...
    public void applyCurrentTo(final FluidTag fluid, final LimeyPlayer entity, final double scale) {
    ...
    private static class Tracker {
        ...
        public void applyCurrentTo(final LimeyPlayer player, final double scale) {
