...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(LimeyPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, LimeyPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(LimeyMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(LimeyMath.clamp(vector.getZ(), -0.15F, 0.15F));
