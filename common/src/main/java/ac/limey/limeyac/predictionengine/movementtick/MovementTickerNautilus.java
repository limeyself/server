...
import ac.limey.limeyac.predictionengine.predictions.rideable.PredictionEngineNautilusWater;
...
public class MovementTickerNautilus extends MovementTickerLivingVehicle {
    ...
    public MovementTickerNautilus(LimeyPlayer player) {
        super(player);
    ...
    public float getRiddenSpeed(LimeyPlayer player) {
        PacketEntityNautilus nautilus = (PacketEntityNautilus) player.compensatedEntities.self.getRiding();
