...
public class PredictionEngineElytra extends PredictionEngine {
    public static Vector3dm getElytraMovement(LimeyPlayer player, Vector3dm vector, Vector3dm lookVector) {
        float pitchRadians = LimeyMath.radians(player.pitch);
        ...
        // Yeah, slow falling needs a refactor in limey.
    ...
    private void addPossibleStuckSpeedResults(LimeyPlayer player, List<VectorData> results, VectorData result) {
