...
import ac.limey.limeyac.utils.inventory.inventory.AbstractContainerMenu;
import ac.limey.limeyac.utils.inventory.slot.EquipmentSlot;
import ac.limey.limeyac.utils.inventory.slot.ResultSlot;
import ac.limey.limeyac.utils.inventory.slot.Slot;
import ac.limey.limeyac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(LimeyPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
