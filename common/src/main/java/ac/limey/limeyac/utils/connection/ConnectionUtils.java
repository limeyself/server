package ac.limey.limeyac.utils.connection;
...
public class ConnectionUtils {
    ...
    public void sendPacketPreVia(@NotNull LimeyPlayer player, @NotNull PacketWrapper<?> wrapper) {
        injectPacketPreVia(player, wrapper, PacketSide.SERVER);
    }

    public void sendPacketPreVia(@NotNull LimeyPlayer player, @NotNull Object buffer) {
        injectPacketPreVia(player, buffer, PacketSide.SERVER);
    }

    public void receivePacketPreVia(@NotNull LimeyPlayer player, @NotNull PacketWrapper<?> wrapper) {
        injectPacketPreVia(player, wrapper, PacketSide.CLIENT);
    }

    public void receivePacketPreVia(@NotNull LimeyPlayer player, @NotNull Object buffer) {
        injectPacketPreVia(player, buffer, PacketSide.CLIENT);
    }

    public void injectPacketPreVia(@NotNull LimeyPlayer player, @NotNull PacketWrapper<?> wrapper, @NotNull PacketSide side) {
    ...
    public void injectPacketPreVia(@NotNull LimeyPlayer player, @NotNull Object buffer, @NotNull PacketSide side) {
        Objects.requireNonNull(player, "player");
