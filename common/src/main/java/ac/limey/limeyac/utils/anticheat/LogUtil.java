...
public class LogUtil {
    ...
    public Logger getLogger() {
        return LimeyAPI.INSTANCE.getLimeyPlugin().getLogger();
    }

    public void console(final String info) {
        LimeyAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(MessageUtil.translateAlternateColorCodes('&', info));
    }

    public void console(final Component info) {
        LimeyAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(info);
    }
