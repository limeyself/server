...
public class GetBoundingBox {
    public static @NotNull SimpleCollisionBox getCollisionBoxForPlayer(@NotNull LimeyPlayer player, double centerX, double centerY, double centerZ) {
        if (player.inVehicle()) {
    ...
    public static @NotNull SimpleCollisionBox getPacketEntityBoundingBox(LimeyPlayer player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static @NotNull SimpleCollisionBox getPlayerBoundingBox(@NotNull LimeyPlayer player, double centerX, double minY, double centerZ) {
    ...
    public static @NotNull SimpleCollisionBox getBoundingBoxFromPosAndSize(@NotNull LimeyPlayer player, double centerX, double minY, double centerZ, float width, float height) {
    ...
    public static double @NotNull [] getEntityDimensions(LimeyPlayer player, @NotNull PacketEntity entity) {
        final float scale = (float) entity.getAttributeValue(Attributes.SCALE);
    ...
    public static void expandBoundingBoxByEntityDimensions(@NotNull SimpleCollisionBox box, LimeyPlayer player, PacketEntity entity) {
