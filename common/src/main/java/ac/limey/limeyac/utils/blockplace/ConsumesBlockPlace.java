...
import ac.limey.limeyac.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull LimeyPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
