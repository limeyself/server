...
public class Slot {
    ...
    public ItemStack safeTake(int amount, int maxAmount, LimeyPlayer player) {
    ...
    public Optional<ItemStack> tryRemove(int amount, int maxAmount, LimeyPlayer player) {
    ...
    // No override
    public boolean allowModification(LimeyPlayer player) {
