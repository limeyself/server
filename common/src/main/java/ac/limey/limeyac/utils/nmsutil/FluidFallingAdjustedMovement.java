...
public class FluidFallingAdjustedMovement {
    public static @NotNull Vector3dm getFluidFallingAdjustedMovement(@NotNull LimeyPlayer player, double gravity, boolean isFalling, @NotNull Vector3dm velocity) {
