...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox getLegacyBoundingBox(LimeyPlayer player, ClientVersion version, int x, int y, int z) {
    ...
    public Set<BlockFace> getLegacyStates(LimeyPlayer player, ClientVersion version, int x, int y, int z) {
