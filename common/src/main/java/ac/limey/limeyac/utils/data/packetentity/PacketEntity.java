...
import ac.limey.limeyac.utils.data.ReachInterpolationData;
import ac.limey.limeyac.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(LimeyPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(LimeyPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(LimeyPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, LimeyPlayer player) {
        if (hasPos) {
            if (relative) {
    ...
    public void setPositionRaw(LimeyPlayer player, SimpleCollisionBox box) {
