// This file was designed and is an original check for LimeyBukkitLoaderPlugin
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(LimeyPlayer player, SimpleCollisionBox startingLocation, TrackedPosition position, PacketEntity entity) {
    ...
    public ReachInterpolationData(LimeyPlayer player, SimpleCollisionBox finishedLoc, PacketEntity entity) {
    ...
    public void updatePossibleStartingLocation(SimpleCollisionBox possibleLocationCombined) {
        //LimeyBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Updated new starting location as second trans hasn't arrived " + startingLocation);
        this.startingLocation = combineCollisionBox(startingLocation, possibleLocationCombined);
        //LimeyBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Finished updating new starting location as second trans hasn't arrived " + startingLocation);
    }
