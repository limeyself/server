...
import ac.limey.limeyac.utils.data.BlockPrediction;
import ac.limey.limeyac.utils.data.Pair;
import ac.limey.limeyac.utils.data.PistonData;
import ac.limey.limeyac.utils.data.ShulkerData;
import ac.limey.limeyac.utils.data.packetentity.PacketEntity;
import ac.limey.limeyac.utils.data.packetentity.PacketEntityShulker;
...
public class CompensatedWorld implements PacketWorld {
    ...
    public CompensatedWorld(LimeyPlayer player) {
        this.player = player;
    ...
    public float getWaterFluidLevelAt(double x, double y, double z) {
        return getWaterFluidLevelAt(LimeyMath.floor(x), LimeyMath.floor(y), LimeyMath.floor(z));
    }
