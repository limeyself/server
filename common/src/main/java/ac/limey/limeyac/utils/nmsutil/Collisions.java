...
import ac.limey.limeyac.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_10;
import ac.limey.limeyac.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_2;
import ac.limey.limeyac.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_4;
import ac.limey.limeyac.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_5;
import ac.limey.limeyac.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_6;
import ac.limey.limeyac.utils.chunks.Column;
...
import ac.limey.limeyac.utils.data.tags.SyncedTags;
import ac.limey.limeyac.utils.functions.BlockAndPositionConsumer;
import ac.limey.limeyac.utils.functions.BlockAndPositionPredicate;
...
public final class Collisions {
    ...
    public static boolean slowCouldPointThreeHitGround(LimeyPlayer player, double x, double y, double z) {
    ...
    public static Vector3dm collide(LimeyPlayer player, double desiredX, double desiredY, double desiredZ) {
        return collide(player, desiredX, desiredY, desiredZ, desiredY, null);
    }

    public static Vector3dm collide(LimeyPlayer player, double desiredX, double desiredY, double desiredZ, double clientVelY, VectorData data) {
    ...
    public static boolean addWorldBorder(LimeyPlayer player, SimpleCollisionBox wantedBB, List<SimpleCollisionBox> listOfBlocks, boolean onlyCheckCollide) {
    ...
    public static boolean getCollisionBoxes(LimeyPlayer player, SimpleCollisionBox wantedBB, List<SimpleCollisionBox> listOfBlocks, boolean onlyCheckCollide) {
    ...
    public static boolean isEmpty(LimeyPlayer player, SimpleCollisionBox playerBB) {
    ...
    public static Vector3dm maybeBackOffFromEdge(Vector3dm vec3, LimeyPlayer player, boolean overrideVersion) {
    ...
    public static boolean isAboveGround(LimeyPlayer player) {
    ...
    public static void handleInsideBlocks(LimeyPlayer player) {
    ...
    public static void onInsideBlock(LimeyPlayer player, Vector3dm clientVelocity, boolean onlyApplyVelocity, StateType blockType, WrappedBlockState block, int blockX, int blockY, int blockZ, boolean magic) {
    ...
    public static void applyEffectsFromBlocks(LimeyPlayer player) {
        ...
        if (clientVersion.isOlderThan(ClientVersion.V_1_21_5)) {
            player.finalMovementsThisTick.add(new LimeyPlayer.Movement(from, to));
            ...
            if (player.finalMovementsThisTick.isEmpty()) {
                ...
                player.finalMovementsThisTick.add(new LimeyPlayer.Movement(player.finalMovementsThisTick.get(player.finalMovementsThisTick.size() - 1).to(), to));
            }
        }
    ...
    public static void resolveBlockEffects(LimeyPlayer player, Vector3d from, Vector3d to) {
        Collisions.resolveBlockEffects(player, List.of(new LimeyPlayer.Movement(from, to)));
    }

    public static void resolveBlockEffects(LimeyPlayer player, List<LimeyPlayer.Movement> movements) {
        resolveBlockEffects(player, player.clientVelocity, false, movements);
    }

    public static void resolveBlockEffects(LimeyPlayer player, Vector3dm clientVelocity, boolean onlyApplyVelocity, List<LimeyPlayer.Movement> movements) {
    ...
    private static double getOldDeltaY(LimeyPlayer player, double value) {
        return player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_21_2) ? value / 0.98F + 0.08 : value;
    }

    private static double getNewDeltaY(LimeyPlayer player, double value) {
        return player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_21_2) ? (value - 0.08) * 0.98F : value;
    }

    private static boolean isSlidingDown(Vector3dm vector, LimeyPlayer player, int locationX, int locationY,
                                         int locationZ) {
        if (player.onGround) {
            return false;
    ...
    public static boolean suffocatesAt(LimeyPlayer player, SimpleCollisionBox playerBB) {
    ...
    public static boolean doesBlockSuffocate(LimeyPlayer player, int x, int y, int z) {
        WrappedBlockState data = player.compensatedWorld.getBlock(x, y, z);
    ...
    // Thanks Tuinity
    public static boolean hasMaterial(LimeyPlayer player, SimpleCollisionBox checkBox, @NotNull BlockAndPositionPredicate searchingFor) {
    ...
    // Thanks Tuinity
    public static void forEachCollisionBox(@NotNull LimeyPlayer player, @NotNull SimpleCollisionBox checkBox, @NotNull BlockAndPositionConsumer searchingFor) {
    ...
    public static boolean onClimbable(LimeyPlayer player, double x, double y, double z) {
    ...
    public static boolean trapdoorUsableAsLadder(LimeyPlayer player, double x, double y, double z, WrappedBlockState blockData) {
