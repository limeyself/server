...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(LimeyPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(LimeyPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(LimeyPlayer player, Set<VectorData> possibleVectors) {
        ...
        float yawRadians = LimeyMath.radians(player.yaw);
