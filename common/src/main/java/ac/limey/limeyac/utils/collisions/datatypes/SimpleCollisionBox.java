...
import ac.limey.limeyac.utils.nmsutil.Ray;
...
public class SimpleCollisionBox implements CollisionBox {
    ...
    public Vector3d getCenter() {
        return new Vector3d(LimeyMath.lerp(0.5, this.minX, this.maxX), LimeyMath.lerp(0.5, this.minY, this.maxY), LimeyMath.lerp(0.5, this.minZ, this.maxZ));
    }
    ...
    public static Vector3i containing(double x, double y, double z) {
        return new Vector3i(LimeyMath.floor(x), LimeyMath.floor(y), LimeyMath.floor(z));
    }
    ...
    public static Iterable<Vector3i> betweenCornersInDirection(SimpleCollisionBox boundingBox, Vector3d directionVector) {
        int minX = LimeyMath.floor(boundingBox.minX);
        int minY = LimeyMath.floor(boundingBox.minY);
        int minZ = LimeyMath.floor(boundingBox.minZ);
        int maxX = LimeyMath.floor(boundingBox.maxX);
        int maxY = LimeyMath.floor(boundingBox.maxY);
        int maxZ = LimeyMath.floor(boundingBox.maxZ);
