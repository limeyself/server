package ac.limey.limeyac.utils.math;
...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(LimeyMath.square(this.x) + LimeyMath.square(this.y) + LimeyMath.square(this.z));
    }

    public double lengthSquared() {
        return LimeyMath.square(this.x) + LimeyMath.square(this.y) + LimeyMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return LimeyMath.square(this.x - oX) + LimeyMath.square(this.y - oY) + LimeyMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return LimeyMath.square(origin.x - this.x) + LimeyMath.square(origin.y - this.y) + LimeyMath.square(origin.z - this.z) <= LimeyMath.square(radius);
    }
    ...
    public int getBlockX() {
        return LimeyMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return LimeyMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return LimeyMath.mojangFloor(this.z);
    }
