...
public class JumpPower {
    public static void jumpFromGround(@NotNull LimeyPlayer player, @NotNull Vector3dm vector) {
        ...
        if (player.isSprinting) {
            float radRotation = LimeyMath.radians(player.yaw);
    ...
    public static float getJumpPower(@NotNull LimeyPlayer player) {
    ...
    public static float getPlayerJumpFactor(@NotNull LimeyPlayer player) {
