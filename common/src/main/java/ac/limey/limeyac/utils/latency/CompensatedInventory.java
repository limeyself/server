...
import ac.limey.limeyac.utils.inventory.inventory.MenuType;
import ac.limey.limeyac.utils.inventory.inventory.NotImplementedMenu;
...
public class CompensatedInventory extends Check implements PacketReceiveListener, PacketSendListener {
    ...
    public CompensatedInventory(LimeyPlayer playerData) {
        super(playerData);
