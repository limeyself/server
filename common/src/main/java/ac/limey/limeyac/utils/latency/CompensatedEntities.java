...
import ac.limey.limeyac.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import ac.limey.limeyac.utils.nmsutil.BoundingBoxSize;
import ac.limey.limeyac.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(LimeyPlayer player) {
        this.player = player;
