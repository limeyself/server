package ac.limey.limeyac.utils.collisions.blocks;
...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(LimeyPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(LimeyPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
