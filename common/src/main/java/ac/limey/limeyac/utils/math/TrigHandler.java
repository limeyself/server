...
public class TrigHandler {
    ...
    public TrigHandler(LimeyPlayer player) {
        this.player = player;
    }
    ...
    public Vector3dm getVanillaMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3;
        float f4;
        float radians = LimeyMath.radians(f2);
    ...
    public Vector3dm getShitMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.sin(LimeyMath.radians(f2)) : LegacyFastMath.sin(LimeyMath.radians(f2));
        float f4 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.cos(LimeyMath.radians(f2)) : LegacyFastMath.cos(LimeyMath.radians(f2));
