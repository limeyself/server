package ac.limey.limeyac.utils.collisions;

import ac.limey.limeyac.player.LimeyPlayer;
import ac.limey.limeyac.predictionengine.movementtick.MovementTickerStrider;
import ac.limey.limeyac.utils.collisions.blocks.DoorHandler;
import ac.limey.limeyac.utils.collisions.blocks.DynamicChest;
import ac.limey.limeyac.utils.collisions.blocks.DynamicChorusPlant;
import ac.limey.limeyac.utils.collisions.blocks.DynamicStair;
import ac.limey.limeyac.utils.collisions.blocks.PistonBaseCollision;
import ac.limey.limeyac.utils.collisions.blocks.PistonHeadCollision;
import ac.limey.limeyac.utils.collisions.blocks.TrapDoorHandler;
import ac.limey.limeyac.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.limey.limeyac.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.limey.limeyac.utils.collisions.blocks.connecting.DynamicCollisionWall;
import ac.limey.limeyac.utils.collisions.datatypes.CollisionBox;
import ac.limey.limeyac.utils.collisions.datatypes.CollisionFactory;
import ac.limey.limeyac.utils.collisions.datatypes.ComplexCollisionBox;
import ac.limey.limeyac.utils.collisions.datatypes.DynamicCollisionBox;
import ac.limey.limeyac.utils.collisions.datatypes.HexCollisionBox;
import ac.limey.limeyac.utils.collisions.datatypes.HexOffsetCollisionBox;
import ac.limey.limeyac.utils.collisions.datatypes.NoCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(LimeyPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(LimeyPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
    ...
    @Override
    public CollisionBox fetch(LimeyPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
