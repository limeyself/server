...
import ac.limey.limeyac.utils.data.packetentity.*;
...
public final class BoundingBoxSize {
    ...
    public static float getWidth(LimeyPlayer player, PacketEntity packetEntity) {
    ...
    private static float getWidthMinusBaby(LimeyPlayer player, PacketEntity packetEntity) {
    ...
    public static Vector3d getRidingOffsetFromVehicle(PacketEntity entity, LimeyPlayer player) {
        ...
        if (entity instanceof PacketEntityTrackXRot xRotEntity) {
            ...
            if (EntityTypes.isTypeInstanceOf(entity.getType(), EntityTypes.BOAT)) {
                ...
                vec3 = yRot(LimeyMath.radians(-xRotEntity.interpYaw) - ((float) Math.PI / 2f), vec3);
                return new Vector3d(x + vec3.x, y + (double) f1, z + vec3.z);
            } else if (entity.getType() == EntityTypes.LLAMA) {
                float f = player.trigHandler.cos(LimeyMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.sin(LimeyMath.radians(xRotEntity.interpYaw));
                ...
                float f = player.trigHandler.sin(LimeyMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.cos(LimeyMath.radians(xRotEntity.interpYaw));
    ...
    public static float getHeight(LimeyPlayer player, PacketEntity packetEntity) {
    ...
    public static double getPassengerRidingOffset(LimeyPlayer player, PacketEntity packetEntity) {
    ...
    private static float getHeightMinusBaby(LimeyPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.getType();
    ...
    private static float getBabyScaleFactor(LimeyPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.getType();
