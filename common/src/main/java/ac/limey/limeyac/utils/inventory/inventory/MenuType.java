...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(LimeyPlayer player, Inventory playerInventory, MenuType type) {
        return switch (type) {
    ...
    public static AbstractContainerMenu getMenuFromString(LimeyPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
