...
final class IdentityLiveWriteHooks implements LiveWriteHooks {
    ...
    @Override public void onQuitFromUserDisconnect(@NotNull User user, @Nullable LimeyPlayer limeyPlayer, long now) {}
    @Override public void observeBrandFromCheck(@NotNull LimeyPlayer limeyPlayer) {}
