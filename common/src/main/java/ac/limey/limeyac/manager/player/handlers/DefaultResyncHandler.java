package ac.limey.limeyac.manager.player.handlers;
...
public record DefaultResyncHandler(LimeyPlayer player) implements ResyncHandler {

    private static void resyncPositions(LimeyPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        LimeyAPI.INSTANCE.getScheduler().getRegionScheduler().execute(LimeyAPI.INSTANCE.getLimeyPlugin(), world,
    ...
    private static void resyncPosition(LimeyPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        LimeyAPI.INSTANCE.getScheduler().getRegionScheduler().execute(LimeyAPI.INSTANCE.getLimeyPlugin(), world, chunkX, chunkZ, () -> {
