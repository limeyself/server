...
final class OwnershipHeartbeatScheduler {
    ...
    private final @Nullable String limeyVersion;
    ...
    OwnershipHeartbeatScheduler(
        ...
        this.limeyVersion = limeyVersion;
    ...
    void start() {
        synchronized (lifecycleLock) {
            ...
            executor = Executors.newSingleThreadScheduledExecutor(r -> {
                Thread t = new Thread(r, "limey-storage-ownership-" + serverName);
                t.setDaemon(true);
                schedulerThread = t;
                return t;
            });
    ...
    private void onLostOwnership() {
        ...
        logger.warning("[limey-datastore] lost DB ownership for instanceId=" + instanceId
