...
public class FabricOfficialSenderFactory extends AbstractFabricSenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = LimeyFabricOfficialLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = LimeyFabricOfficialLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    public void sendMessage(CommandSourceStack source, Component message) {
        net.minecraft.network.chat.Component nativeText =
                (net.minecraft.network.chat.Component) LimeyFabricOfficialLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message);
