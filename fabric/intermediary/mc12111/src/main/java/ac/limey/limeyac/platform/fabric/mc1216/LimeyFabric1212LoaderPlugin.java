...
import ac.limey.limeyac.platform.fabric.mc1216.convert.Fabric1216ConversionUtil;
import ac.limey.limeyac.platform.fabric.mc1216.player.Fabric1212PlatformPlayer;
import ac.limey.limeyac.platform.fabric.mc1216.player.Fabric1215PlatformInventory;
import ac.limey.limeyac.platform.fabric.player.FabricPlatformPlayerFactory;
import com.github.retrooper.packetevents.PacketEvents;
import com.github.retrooper.packetevents.manager.server.ServerVersion;

public class LimeyFabric1212LoaderPlugin extends LimeyFabric1190LoaderPlugin {

    public LimeyFabric1212LoaderPlugin() {
        super(
                LimeyFabric1212LoaderPlugin::createCommandArguments,
