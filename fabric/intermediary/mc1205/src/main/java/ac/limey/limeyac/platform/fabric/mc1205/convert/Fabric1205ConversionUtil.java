package ac.limey.limeyac.platform.fabric.mc1205.convert;
...
public class Fabric1205ConversionUtil implements IFabricConversionUtil {
    ...
    public ItemStack fromFabricItemStack(Object fabricItemStack) {
        ...
        try {
            RegistryAccess registryManager = LimeyFabricIntermediaryLoaderPlugin.FABRIC_SERVER.registryAccess();
