package ac.limey.limeyac.platform.fabric.sender;
...
public class FabricIntermediarySenderFactory extends AbstractFabricSenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = LimeyFabricIntermediaryLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = LimeyFabricIntermediaryLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    public void sendMessage(CommandSourceStack sender, Component message) {
        net.minecraft.network.chat.Component nativeText =
                (net.minecraft.network.chat.Component) LimeyFabricIntermediaryLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message);
