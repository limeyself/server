package ac.limey.limeyac.platform.fabric.utils;
...
/**
 * Binds a Polymer/fabric-api {@code PacketContext} around Limey's out-of-pipeline {@code ItemStack}
 * encoding so that Polymer can encode items without crashing. See LimeyAnticheat/Limey#2701.
 *
 ...
 *
 * <p>Limey encodes {@code ItemStack}s outside of the Netty pipeline when it reads a player's inventory
    ...
    static {
        ...
        if (FabricLoader.getInstance().isModLoaded("polymer-core")) {
            try {
                ...
                LogUtil.info("[Limey] Polymer is present but fabric-api's PacketContext API is unavailable; "
