...
import ac.limey.limeyac.platform.fabric.utils.FabricItemContextHook;
...
public abstract class AbstractFabricPlatformInventory implements PlatformInventory {
     ...
     * inventory owner bound so Polymer can encode the item instead of crashing (LimeyAnticheat/Limey#2701).
