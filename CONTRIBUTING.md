...
Thank you for your interest in contributing to Limey. This document outlines the guidelines for
making pull
...
- **Compatibility**
  ...
  the [supported environments](https://github.com/LimeyAnticheat/Limey/wiki/Supported-environments) (Spigot, Paper, Folia, Fabric, etc.)
...
- Limey is built using [Gradle](https://gradle.org/) kotlin scripts.
- Java 21 is currently required to build the project. A minimum of Java 17 is required to run it.

### Questions & Support

- Join our [Discord](https://discord.limey.ac) if you have questions or need assistance.
- Refer to the [Wiki](https://github.com/LimeyAnticheat/Limey/wiki) for project documentation.
